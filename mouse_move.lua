...
-- move floating windows
    ...
    awful.key({ "Control","Shift" } , "KP_Divide", function ()  awful.util.spawn("transset-df -p --inc 0.1") end),
    awful.key({ "Control","Shift" } , "KP_Multiply", function ()  awful.util.spawn("transset-df -p --dec 0.1") end),
